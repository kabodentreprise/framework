...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <div class="flex justify-between items-center mb-8 border-b border-gray-100 pb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Nouveau Contenu</h2>
                <p class="text-sm text-gray-500 mt-1">Remplissez les informations ci-dessous pour créer un nouveau contenu.</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Ex: Les traditions du Sud-Comoé"
                           value="{{ old('titre') }}" 
                           required>
                    @error('titre')
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex gap-4 mt-2">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="type_acces" value="gratuit" class="form-radio text-orange-600 focus:ring-orange-500 border-gray-300" {{ old('type_acces', 'gratuit') == 'gratuit' ? 'checked' : '' }} onchange="togglePrixField()">
                                    <span class="ml-2 text-gray-700">Gratuit</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="type_acces" value="payant" class="form-radio text-orange-600 focus:ring-orange-500 border-gray-300" {{ old('type_acces') == 'payant' ? 'checked' : '' }} onchange="togglePrixField()">
                        ...
                        <div id="prix-container" class="{{ old('type_acces', 'gratuit') == 'payant' ? '' : 'hidden' }}">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Le formatage Markdown ou HTML est accepté.</p>
                    @error('texte')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
