...
@section('page-title', 'Créer un Type de Média')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800">Nouveau Type de Média</h2>
        ...
        <form action="{{ route('admin.type-medias.store') }}" method="POST">
            @csrf
