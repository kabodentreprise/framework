...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800">Modifier le Rôle</h2>
        ...
        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
            ...
            <div class="flex justify-end gap-3 mt-8 border-t pt-6">
                <a href="{{ route('admin.roles.index') }}" class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 font-medium transition-colors">
                    Annuler
                </a>
