...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="overflow-x-auto">
        <table id="rolesTable" class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-white uppercase bg-orange-600">
                <tr>
                    <th scope="col" class="px-6 py-3 rounded-tl-lg">ID</th>
                    <th scope="col" class="px-6 py-3">Nom du rôle</th>
